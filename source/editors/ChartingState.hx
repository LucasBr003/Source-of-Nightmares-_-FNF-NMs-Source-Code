...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		// Custom Hard Coded Events
		['Big Lane', "Makes the Lane bigger."],
		['Disable / Enable Effects', "Disable or enable the Chromatic Aberration\nand the Shaking effects"],
		['Remove Lane', "Removes the Lane for the rest of the song."],
		['Split Screen', "Splits the screen in 'two'\n\nValue 1: Must Hit Section (BF Turn)\nTrue / False\n\nValue 2: Time"],
		['Zoom Frequency', "Changes how often the camera zooms.\n\nValue 1: New Frequency in Beats.\n\nDefault is 4."],

		// Soft Coded Events
		['BF Shoot', "When this event is triggered, Nightmare Boyfriend\nwill shoot a giant beam towards the player.\n\nValue 1: Warn? (Yes or True / No or False)"],
		['Change Icon', "Changes the Animated Icon.\n\nValue 1: New Icon\n\nAvailable Icons:\n- Nightmare BF\n- Eteled\n- Bambi\n- Tricky"],
		['Fire Raises', "Raises and shows the fire in the Night Mall BG.\nOnly works in the Night Mall BG.\n\nValue 1: How long it takes to fully raises the fire."],
		['Health Drain', "Enables / Disables the Health Drain.\n\nIf the Health Drain is enabled,\nit will disable it.\n\nIf the Health Drain is disabled,\nit will enable it"],
		['Imposter Kill', "No Explanation is Needed.\n\nValue 1: Current Beat."],
		['Introduce Dodge', "Triggering this event will enable / disable the dodging\nmechanics.\n\nThe dodge indicator will remain hidden until so."],
		['Screen Fix', "Fixes the game screen.\nUseless if not used correctly."],
		['Set Corn Properties', 'Sets the Cornfields Properties\n(Bambi Mechanic)\n\nValue 1: Grow Speed (Default: 0.125)\nValue 2: Down Strength (Default: 10.7)\n\nLeave it blank to keep the last value.'],
		['Tricky Signs', "Spawns a pattern of signs that covers the notes.\n\nValue 1: Pattern Type (1 - 3)"],

		// Transcribed Events
		['Checkpoint', "(Night Mall Only)\n\nGives the player a checkpoint, so when they die\nthey don't have to start the song all over again.\n\nWon't work if the Mechanic Difficulty is NIGHTMARE."]
	];
