...
class Controls extends FlxActionSet
{
	...
	public var DODGEB(get, never):Bool;

	inline function get_DODGEB()
		return _dodge.check();
	...
	public function setKeyboardScheme(scheme:KeyboardScheme, reset = true)
	{
		...
		switch (scheme)
		{
			case Solo:
				...
				inline bindKeys(Control.DODGEB, keysMap.get('dodge'));
				inline bindKeys(Control.ERASE, keysMap.get('erase'));
			case Duo(true):
				...
				inline bindKeys(Control.DODGEB, [SPACE]);
				inline bindKeys(Control.ERASE, [DELETE]);
			case Duo(false):
